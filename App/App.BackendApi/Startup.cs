...
namespace App.BackendApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString(SystemConstants.Database.MessengerConnectionString));
            });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger Messenger Solution", Version = "v1" });
